...
The Microsoft Kiota abstractions library for Python is the python package that defines the basic constructs Kiota projects need once an SDK has been generated from an OpenAPI definition.
